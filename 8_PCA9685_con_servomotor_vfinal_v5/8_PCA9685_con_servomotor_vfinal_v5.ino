...
void setup() {
  ...
  servos1.setPWMFreq(50);  // Analog servos run at ~50 Hz updates. Determines how many full 'pulses' per second are generated by the IC
...
void loop() {
  ...
  // servos1.setPWM(servonum, 400, 0); // sentido antihoario
  // delay(2000);
  // servos1.setPWM(servonum, 0, 0); // detener
  // delay(2000);
  servos1.setPWM(servonum, 0, convert2angle(360)); // sentido antihorario
  delay(2000);
  servos1.setPWM(servonum, 0, 0); // detener. El mejor
  delay(2000);
  servos1.setPWM(servonum, 0, convert2angle(90)); // sentido horario
  delay(2000);
  servos1.setPWM(servonum, 0, 2500); // detener
  delay(2000);
}
