...
void callback(char* topic, byte* message, unsigned int length){
  ...
  if(String(topic) == "esp8266/led1"){ // Si recibe mensaje sobre topic "esp8266/output1", verifica si es "on" o "off"
...
void reconnect(){
  ...
  while(!client.connected()){
      ...
      if(client.connect("ESP8266Client")){
        ...
        client.subscribe("esp8266/led1"); // Topic : 'esp8266/output1'
        client.subscribe("esp8266/led2"); // Topic : 'esp8266/output2'
      }else{
